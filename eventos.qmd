...
<div style="text-align:center; margin-bottom:1.5rem;">
  <img src="fotos/eventos/aerea_1.jpg" alt="Vista aérea del Arboretum de Estancia La Constancia" style="width:100%; max-height:420px; object-fit:cover; border-radius:14px; box-shadow:0 6px 20px rgba(0,0,0,.15);">
</div>
...
[✉️ Solicitar una propuesta](contacto.qmd){.btn .btn-success .btn-lg role="button"}
&nbsp;
[📄 Descargar dossier corporativo](recursos/dossier_empresas.pdf){.btn .btn-outline-success .btn-lg role="button"}
</div>
...
- 🗂️ **Coordinación del evento** y armado a medida.
- 🍽️ **Gastronomía / catering** a convenir. <!-- COMPLETAR: propio, exclusivo, o libre elección -->
- 🌿 **Actividades guiadas opcionales**: recorridos botánicos, avistaje de aves, baños de bosque, plantación.
- 🚗 **Estacionamiento** en el predio. <!-- COMPLETAR / confirmar -->
...
::: {.g-col-12 .g-col-md-4}
![](fotos/eventos/aerea_2.jpg){style="width:100%; height:220px; object-fit:cover; border-radius:10px;"}
:::

::: {.g-col-12 .g-col-md-4}
![](fotos/eventos/fuente_atardecer.jpg){style="width:100%; height:220px; object-fit:cover; border-radius:10px;"}
:::

::: {.g-col-12 .g-col-md-4}
![](fotos/eventos/arbol_otono.jpg){style="width:100%; height:220px; object-fit:cover; border-radius:10px;"}
:::
...
<a href="https://instagram.com/laconstanciadebiocca" target="_blank" rel="noopener" class="btn btn-outline-success" role="button">📸 @laconstanciadebiocca</a>
