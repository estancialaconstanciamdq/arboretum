...
Un vistazo en video a una visita educativa en el Arboretum:
...
<div style="display:flex; justify-content:center; margin:1.2rem 0 1.8rem;">
  <iframe style="width:315px; max-width:100%; aspect-ratio:9/16; border:0; border-radius:14px; box-shadow:0 4px 18px rgba(0,0,0,.18);"
    ...
    title="Video institucional — Visitas Educativas en el Arboretum"
...
### <i class="bi bi-clipboard-check"></i> Metodología
...
<div class="button-group">
  <a href="https://drive.google.com/file/d/14D3vhpElerGzZ7zvj4Bl9eC0NmbUTvj6/view?usp=drive_link" target="_blank" rel="noopener noreferrer" class="btn btn-success" role="button">
    <i class="bi bi-file-earmark-text"></i> Brochure Visitas Educativas
  </a>
</div>
...
<div class="button-group">
  <a href="programas/programa_inicial.pdf" target="_blank" rel="noopener noreferrer" class="btn btn-success" role="button">
    <i class="bi bi-balloon"></i> Programa Inicial
  </a>
  ...
  <a href="programas/programa_secundaria.pdf" target="_blank" rel="noopener noreferrer" class="btn btn-success" role="button">
    <i class="bi bi-book"></i> Programa Secundaria
  </a>
</div>
...
#### <i class="bi bi-pin-angle"></i> Condiciones Generales de Reserva
