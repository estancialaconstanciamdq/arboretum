...
<section class="home-hero">
  <div class="home-hero-inner">
    ...
    <div class="home-hero-btns">
      <a href="../experiencias.html" class="btn btn-success btn-lg" role="button">See experiences</a>
      <a href="../apadrina.html" class="btn btn-lg home-hero-ghost" role="button"><i class="bi bi-tree"></i> Sponsor a tree</a>
    </div>
  </div>
</section>
```
...
[See experiences](../experiencias.html){.btn .btn-success role="button"} &nbsp; [<i class="bi bi-tree"></i> Sponsor a tree](../apadrina.html){.btn .btn-outline-success role="button"}
:::
...
[See visits →](../visitas_escolares.html){.btn .btn-outline-success .btn-sm .mt-auto role="button"}
:::
...
[Sponsor →](../apadrina.html){.btn .btn-outline-success .btn-sm .mt-auto role="button"}
:::
...
[See proposal →](../empresas.html){.btn .btn-outline-success .btn-sm .mt-auto role="button"}
:::
...
[Become a volunteer →](../voluntariado.html){.btn .btn-outline-success .btn-sm .mt-auto role="button"}
:::
...
[See experiences →](../experiencias.html){.btn .btn-outline-success .btn-sm .mt-auto role="button"}
:::
...
[Open the map →](../mapa.html){.btn .btn-success .btn-sm .mt-auto role="button"}
:::
...
[Explore species →](../especies.html){.btn .btn-outline-success .btn-sm .mt-auto role="button"}
:::
...
[Explore birds →](../aves.html){.btn .btn-outline-success .btn-sm .mt-auto role="button"}
:::
