<!-- AUTO-GENERATED FILE — DO NOT EDIT BY HAND.
     Source: data/Arboretum_Master.xlsx (row ARB030).
...
<div class="en-nav">
  ...
  <a href="../../fichas/castanodeindias.html" class="lang">Español &#9656;</a>
</div>
```

![](../../fotos/Castanodeindias.jpg){style="max-width:320px; border-radius:10px;"}

**Scientific name:** <i>Aesculus</i> <i>hippocastanum</i> L.
...
**Continent:** Europe (Balkans)


**Conservation status (IUCN):** <span class="iucn-badge iucn-VU" title="UICN/IUCN: Vulnerable">VU · Vulnerable</span>  
<span style="font-size:.8rem;color:#777;">Global species category · [IUCN Red List](https://www.iucnredlist.org)</span>


## Location

Coordinates: -38.056127, -57.679297

[See on the map »](../map.qmd)

## QR code

![QR code for this profile](../../qr/castanodeindias.png){width=130}
