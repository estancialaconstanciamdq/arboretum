<!-- AUTO-GENERATED FILE — DO NOT EDIT BY HAND.
     Source: data/Arboretum_Master.xlsx (row ARB088).
...
<div class="en-nav">
  ...
  <a href="../../fichas/cedro-del-atlas-arb088.html" class="lang">Español &#9656;</a>
</div>
```

![](../../fotos/Cedroazul.jpg){style="max-width:320px; border-radius:10px;"}

**Scientific name:** <i>Cedrus</i> <i>atlantica</i> (Endl.) Manetti ex Carrière
...
Coordinates: -38.05528, -57.681835

[See on the map »](../map.qmd)

## QR code

![QR code for this profile](../../qr/cedro-del-atlas-arb088.png){width=130}
